...
if P.one_class_idx is not None:
    ...
    full_test_set = test_set #deepcopy(test_set)  # test set of full classes
...
if P.resume_path is None and P.mode == 'sup_linear' or P.mode == 'sup_CSI_linear' or P.mode == 'sup_simclr_CSI':
